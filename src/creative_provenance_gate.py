"""Creative Provenance Gate — SCAFFOLD STUB.

Company lens: Adobe (independent; no affiliation).
Bottleneck: Orchestrating workflows across creative applications and models while retaining editable structure, provenance, and brand control.
...
class CreativeProvenanceGate:
    ...
    - `evaluate(req)` returns a CreativeProvenanceGateReceipt
